...
|---|---:|---:|---|---|
| `a800_shared_training` | `0.5` | `False` | batch / max_length / gradient_accumulation_steps<br>日志 / checkpoint / 记录 |  |
| `adapter_inference` | `1.0` | `True` |  |  |
| `qlora_memory` | `1.0` | `True` |  |  |
| `training_log` | `1.0` | `True` |  |  |
| `eval_vs_train` | `0.75` | `True` | 固定评测 / 人工评估 / benchmark |  |
| `sampling_params` | `0.5` | `False` | 稳定 / 随机<br>发散 / 多样 |  |
