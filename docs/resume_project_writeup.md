...
- 在 KuaiRec big 上完成 hard negative、in-batch negative、ItemCF 蒸馏、LightGCN、序列兴趣模型和轻量文本 encoder 对比，ItemCF 蒸馏 Two-Tower 将 `NDCG@20` 提升到 `0.033562`。
...
1. 扩大 ItemCF 蒸馏 Two-Tower 的训练样本，优化 teacher 权重和 hard negative 配比。
